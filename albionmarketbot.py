...
SELECT_ORDERS_X, SELECT_ORDERS_Y = 812 * MONITOR_RESOLUTION_FACTOR_X, 890 * MONITOR_RESOLUTION_FACTOR_Y
CHECK_X, CHECK_Y, CHECK_WIDTH, CHECK_HEIGHT = 648 * MONITOR_RESOLUTION_FACTOR_X, 521 * MONITOR_RESOLUTION_FACTOR_Y, 50, 30
SILVER_CHECK_X, SILVER_CHECK_Y, SILVER_CHECK_WIDTH, SILVER_CHECK_HEIGHT = 648 * MONITOR_RESOLUTION_FACTOR_X, 550 * MONITOR_RESOLUTION_FACTOR_Y, 120, 30

BUY_GOLD_INPUT_COORDINATES_X, BUY_GOLD_INPUT_COORDINATES_Y = 730 * MONITOR_RESOLUTION_FACTOR_X, 680 * MONITOR_RESOLUTION_FACTOR_Y
SELL_GOLD_INPUT_COORDINATES_X, SELL_GOLD_INPUT_COORDINATES_Y = 730 * MONITOR_RESOLUTION_FACTOR_X, 796 * MONITOR_RESOLUTION_FACTOR_Y

BUY_SILVER_INPUT_COORDINATES_X, BUY_SILVER_INPUT_COORDINATES_Y = 885 * MONITOR_RESOLUTION_FACTOR_X, 679 * MONITOR_RESOLUTION_FACTOR_Y
SELL_SILVER_INPUT_COORDINATES_X, SELL_SILVER_INPUT_COORDINATES_Y = 885 * MONITOR_RESOLUTION_FACTOR_X, 797 * MONITOR_RESOLUTION_FACTOR_Y

BUY_ORDER_COORDINATES_X, BUY_ORDER_COORDINATES_Y = 1317 * MONITOR_RESOLUTION_FACTOR_X, 678 * MONITOR_RESOLUTION_FACTOR_Y
SELL_ORDER_COORDINATES_X, SELL_ORDER_COORDINATES_Y = 1330 * MONITOR_RESOLUTION_FACTOR_X, 794 * MONITOR_RESOLUTION_FACTOR_Y

CONFIRM_BUY_ORDER_X, CONFIRM_BUY_ORDER_Y = 1158 * MONITOR_RESOLUTION_FACTOR_X, 618 * MONITOR_RESOLUTION_FACTOR_Y
CONFIRM_SUBMITTED_X, CONFIRM_SUBMITTED_Y = 963 * MONITOR_RESOLUTION_FACTOR_X, 520 * MONITOR_RESOLUTION_FACTOR_Y

CONFIRM_BUY_ORDER_X, CONFIRM_BUY_ORDER_Y = 1180 * MONITOR_RESOLUTION_FACTOR_X, 631 * MONITOR_RESOLUTION_FACTOR_Y
CONFIRM_SELL_ORDER_X, CONFIRM_SELL_ORDER_Y = 930 * MONITOR_RESOLUTION_FACTOR_X, 518 * MONITOR_RESOLUTION_FACTOR_Y

CLOSE_MARKET_X, CLOSE_MARKET_Y = 1363 * MONITOR_RESOLUTION_FACTOR_X, 246 * MONITOR_RESOLUTION_FACTOR_Y

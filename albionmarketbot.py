...
MARKET_COORDINATES_X, MARKET_COORDINATES_Y = 1694 * MONITOR_RESOLUTION_FACTOR_X, 30 * MONITOR_RESOLUTION_FACTOR_Y = 1
SELECT_ORDERS_X, SELECT_ORDERS_Y = 812 * MONITOR_RESOLUTION_FACTOR_X, 977 * MONITOR_RESOLUTION_FACTOR_Y = 1
CHECK_X, CHECK_Y, CHECK_WIDTH, CHECK_HEIGHT = 568 * MONITOR_RESOLUTION_FACTOR_X, 521 * MONITOR_RESOLUTION_FACTOR_Y = 1, 50, 30
SILVER_CHECK_X, SILVER_CHECK_Y, SILVER_CHECK_WIDTH, SILVER_CHECK_HEIGHT = 570 * MONITOR_RESOLUTION_FACTOR_X, 559 * MONITOR_RESOLUTION_FACTOR_Y = 1, 200, 30

BUY_GOLD_INPUT_COORDINATES_X, BUY_GOLD_INPUT_COORDINATES_Y = 596 * MONITOR_RESOLUTION_FACTOR_X, 708 * MONITOR_RESOLUTION_FACTOR_Y = 1
SELL_GOLD_INPUT_COORDINATES_X, SELL_GOLD_INPUT_COORDINATES_Y = 607 * MONITOR_RESOLUTION_FACTOR_X, 861 * MONITOR_RESOLUTION_FACTOR_Y = 1

BUY_SILVER_INPUT_COORDINATES_X, BUY_SILVER_INPUT_COORDINATES_Y = 777 * MONITOR_RESOLUTION_FACTOR_X, 712 * MONITOR_RESOLUTION_FACTOR_Y = 1
SELL_SILVER_INPUT_COORDINATES_X, SELL_SILVER_INPUT_COORDINATES_Y = 761 * MONITOR_RESOLUTION_FACTOR_X, 855 * MONITOR_RESOLUTION_FACTOR_Y = 1

BUY_ORDER_COORDINATES_X, BUY_ORDER_COORDINATES_Y = 1399 * MONITOR_RESOLUTION_FACTOR_X, 716 * MONITOR_RESOLUTION_FACTOR_Y = 1
SELL_ORDER_COORDINATES_X, SELL_ORDER_COORDINATES_Y = 1410 * MONITOR_RESOLUTION_FACTOR_X, 858 * MONITOR_RESOLUTION_FACTOR_Y = 1

CONFIRM_BUY_ORDER_X, CONFIRM_BUY_ORDER_Y = 1158 * MONITOR_RESOLUTION_FACTOR_X, 641 * MONITOR_RESOLUTION_FACTOR_Y = 1
CONFIRM_SUBMITTED_X, CONFIRM_SUBMITTED_Y = 963 * MONITOR_RESOLUTION_FACTOR_X, 520 * MONITOR_RESOLUTION_FACTOR_Y = 1

CONFIRM_SELL_ORDER_X, CONFIRM_SELL_ORDER_Y = 930 * MONITOR_RESOLUTION_FACTOR_X, 614 * MONITOR_RESOLUTION_FACTOR_Y = 1
